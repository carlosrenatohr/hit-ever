-- ============================================================================
-- Fix create_package: INSERT had 22 values for 21 columns (extra now())
-- ============================================================================
-- 20260815010000_create-package-rpc.sql shipped with one extra now() in the
-- VALUES list, so any call failed with 42601 "INSERT has more expressions than
-- target columns". This migration re-creates the function with the corrected
-- VALUES list (21 values). Idempotent via CREATE OR REPLACE.
-- ============================================================================
