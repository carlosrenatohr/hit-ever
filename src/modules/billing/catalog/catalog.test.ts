...
const tables: OrgRateTable[] = [
  {
    ...
    name: 'Estándar',
    freightType: 'AIR',
    rows: [{ tier: 'REGULAR', price: 7, cost: 4.5 }],
  },
  {
    id: 't-vip',
    name: 'VIP',
    freightType: 'AIR',
    rows: [
      { tier: 'REGULAR', price: 6, cost: 4.5 },
      { tier: 'VIP', price: 5.5, cost: 4.5 },
    ],
  },
  {
    id: 't-mar',
    name: 'Estándar',
    freightType: 'MAR',
    rows: [{ tier: 'REGULAR', price: 2.8, cost: 1.25 }],
  },
]
...
describe('resolveOrgRate', () => {
  ...
  it('skips a default table id that does not belong to the org', () => {
    ...
    expect(r).toEqual({ price: 7, cost: 4.5 })
  })
})
